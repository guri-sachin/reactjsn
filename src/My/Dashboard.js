...
function Dashboard()
{
  ...
  const navigate = useNavigate();
   useEffect(()=>{
      axios.get("http://3.101.23.81:3306/sums").then(res=>setProducts(res.data));
  },[]);

  useEffect(()=>{
    axios.get("http://3.101.23.81:3306/spots").then(res=>setProducts1(res.data));
},[]);

useEffect(()=>{
  axios.get("http://3.101.23.81:3306/newreq").then(res=>setProducts2(res.data));
},[]);

useEffect(()=>{
  axios.get("http://3.101.23.81:3306/current").then(res=>setProducts3(res.data));
},[]);
return(
