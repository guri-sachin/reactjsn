...
{  
  ...
  useEffect(()=>{
     axios.get("http://3.101.23.81:3306/nois").then(res=>setProducts(res.data));
 },[]);
 ...
 function Piya(e){
  ...
  axios.get(`http://3.101.23.81:3306/mino/${id}`).then(
    res => setProducts(res.data));
  
  axios.get(`http://3.101.23.81:3306/kika/${id}`).then(
      res => setProducts(res.data));
      navigate("/Subscribed");
